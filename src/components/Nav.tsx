...
export default function Nav() {
  ...
  return (
    <nav className="z-10 bg-white/80 dark:bg-gray-900/50 sticky top-0 backdrop-blur-sm border-b border-gray-300 dark:border-gray-800">
      <div className="px-4 sm:px-6 lg:px-8 py-2 flex justify-between items-start sm:items-center flex-wrap">
        <div className="flex flex-col sm:flex-row flex-wrap sm:items-center gap-2 sm:gap-8">
          <Link href="/" className="text-xl text-gray-900 dark:text-white">
            ...
            {links.map((link) => (
              <div key={link.href}>
                <Link
                  href={link.href}
                  className={`sm:text-lg transition-colors duration-100 ${
                    pathname === link.href
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* https://www.facebook.com/daniel.herr.14 */}
          <a
            href="https://www.facebook.com/daniel.herr.14"
            target="_blank"
